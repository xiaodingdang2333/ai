...
EXPECTED="桃枝醒醒"
PORT="9224"
BOOK_ID="7654615479075490878"
BOOK_NAME="重生六岁，我带空间抢回军区大院"
AI_USE="yes"
...
LOG_DIR="$WORK_ROOT/output/fanqie-upload/liusui-daily"
LOCK_FILE="$WORK_ROOT/output/fanqie-upload/liusui-daily.lock"
...
exec 9>"$LOCK_FILE"
if ! flock -n 9; then
  log "Another Liusui Fanqie publish job is already running; exit."
  exit 0
fi
