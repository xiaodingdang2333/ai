...
Use $build-report when the user asks for a memo, deck-ready summary, or packaged readout.
...
Use $build-report when the estimate needs a memo, deck-ready summary, or packaged leadership readout.
